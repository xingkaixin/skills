...
When content analysis surfaces no strong signal (generic knowledge article, mixed-topic post, no clear data/comparison/narrative cue), recommend **`hand-drawn-edu`** as the primary option in Step 2 Q1. It is the warm, friendly educational-infographic default — safe for most articles and universally readable.
...
Use this table during Step 2 to recommend presets based on Step 1 content analysis:

| Content Type (Step 1) | Primary Preset | Alternatives |
|------------------------|----------------|--------------|
...
Explicit flags override the corresponding preset dimensions. Saved preferences apply to dimensions left unspecified. Without a palette override, keep the style's built-in colors.
